...
def scan_image(directory, device, mastodon, should_toot, resolution=300):
    ...
    if should_toot:
        ...
        text = f"A livestream from phsarum.computational.life. This is timestep {time.time()}. Let's go #napari October 2023 hackathon."
...
def run():
    ...
    toot_frequency = int(get_args().toot_frequency)
    scan_count = 0  # Counter for scans
